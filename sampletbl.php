...
<head>
    ...
    <style>
        ...
        .bgg {
            background-image: url("/proj/src/bggg1.jpeg");
...
<body>
    ...
    <nav class="site-header sticky-top py-1">
        <div class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <a class="py-2 d-none d-md-inline-block" href="/web.html">Home</a>
          <a class="py-2 d-none d-md-inline-block" href="/brkquotes.html">Broken Quotes</a>
          <a class="py-2 d-none d-md-inline-block" href="/motiv.html">Motivation</a>
          <a class="py-2 d-none d-md-inline-block" href="/healheart.html">Healing Hearts</a>
          <a class="py-2 d-none d-md-inline-block" href="/sadpoet.html">Sad Poetry</a>
      ...
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light bgg">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 font-weight-normal">Broken Heart</h1>
...
<div id="dii">
    ...
    <?php
        while($rows=mysqli_fetch_assoc($result))
        {
            ?>
            <tr>
                <td style="padding:18px;"><?php echo $rows['name']; ?></td>
            </tr>
            <?php
